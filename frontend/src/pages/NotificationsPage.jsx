...
import NotificationsSkeleton from "../components/NotificationsSkeleton.jsx";
...
const NotificationsPage = () => {
    ...
    const renderRelatedPost = (relatedPost) => {
        ...
        return (
            ...
            >
                {relatedPost.image && (
                    <img src={relatedPost.image} alt="Post preview" className="size-10 object-cover rounded"/>
                )}
