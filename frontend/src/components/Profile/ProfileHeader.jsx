            ...
            default:
                return (
                    <button
                        ...
                        className="bg-primary hover:bg-blue-700/80 text-white py-2 px-4 rounded-full transition
        ...
        <div className="bg-white shadow rounded-lg mb-6">
            ...
            <div className="p-4">
                ...
                {isOwnProfile ? (
                    isEditing ? (
                        <button
                            className="w-full bg-primary text-white py-2 px-4 rounded-full hover:bg-blue-700/80 transition
                            duration-300"
                            onClick={handleSave}
                        >
                            Save Profile
